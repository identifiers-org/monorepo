...
import org.identifiers.cloud.commons.compactidparsing.NamespaceInfoSource;
...
public class CompactIdParsingHelperV1 implements CompactIdParsingHelper {
    private final NamespaceInfoSource namespaceInfoSource;
    ...
    public ParsedCompactIdentifier parseCompactIdRequest(String rawCompactIdentifier) {
        ...
        var namespace = namespaceInfoSource.findByPrefix(rawCompactIdentifier.toLowerCase());
        if (namespace != null) {
        ...
        if (rawCompactIdentifier.contains("/")) {
            ...
            if (splitBySlash[0].contains(":")) {
                ...
                if (namespaceInfoSource.findByPrefix(possibleProviderCode) == null) {
                    ...
                    if (rightSide.contains(":")) {
                        ...
                        if (namespaceInfoSource.findByPrefix(possibleNamespace) != null) {
        ...
        if (parsedCompactIdentifier.getNamespace() != null) {
            ...
            var foundNamespace = namespaceInfoSource.findByPrefix(parsedCompactIdentifier.getNamespace());
    ...
    private boolean isNamespaceEmbeddedInLui(String namespace) {
        var namespaceRecord = namespaceInfoSource.findByPrefix(namespace);
