    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                // Curation API
                    ...
                    .requestMatchers(HttpMethod.GET, "/curationApi/enable").hasAuthority("restApiCurationWarningsEnable")
                    .requestMatchers(HttpMethod.GET, "/curationApi/disable").hasAuthority("restApiCurationWarningsDisable")
                // Resolution API
