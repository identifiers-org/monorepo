...
public class CuratorReviewVerifier<T> implements RegistryEntityVerifier<T> {
    ...
    public Optional<CurationWarningNotification> validate(T entity) {
        ...
        if (CURATOR_REVIEW_VALUE.equals(value)) {
            ...
            log.info("Value {} of {} {} is set to {}", fieldName, entityType, entityId, CURATOR_REVIEW_VALUE);
