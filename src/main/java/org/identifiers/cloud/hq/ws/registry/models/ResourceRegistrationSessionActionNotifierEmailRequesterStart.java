...
public class ResourceRegistrationSessionActionNotifierEmailRequesterStart implements ResourceRegistrationSessionAction {
    ...
    @Value("${org.identifiers.cloud.hq.ws.registry.notifiers.requester.resourcereg.start.subject}")
    private String emailSubject;
    @Value("${org.identifiers.cloud.hq.ws.registry.notifiers.requester.resourcereg.start.body.filename}")
    ...
    public ResourceRegistrationSessionActionReport performAction(ResourceRegistrationSession session) throws ResourceRegistrationSessionActionException {
        ...
        try {
            ...
            log.error("Failed to send email on resource request start", ex);
        }
